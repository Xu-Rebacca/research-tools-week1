...
Codex 生成程序的实际运行测试结果如图 \ref{fig:codex} 所示（正常路径与异常用例）。

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/fig3_codex.png}
    \caption{Codex 生成的 text_stats.py 运行测试结果（默认 Top-10、\texttt{-n 5} 与异常用例）}
    \label{fig:codex}
\end{figure}
